...
import { AccountBalanceWallet, AccountBox, AddAPhoto, AddAlert, AddPhotoAlternate, AdsClick, Announcement, BadgeRounded, Balance, BrowseGallery, Campaign, Contacts, Description, EventAvailable, ExpandLess, ExpandMore, ForwardToInbox, GroupAdd, Insights, LocalLibrary, LockOpen, Logout, ManageHistory, ModelTraining, NoteAdd, PersonAdd, RequestQuote, SupervisedUserCircle, UploadFile, WorkHistory, WorkOff } from '@mui/icons-material';
