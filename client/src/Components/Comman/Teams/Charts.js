    ...
    return (
        <>
            <Container sx={{ display: "flex", flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '90%' }}>
                ...
                <Box sx={{ display: "flex", flexDirection: 'column', justifyContent: 'flex-start',height:'70%', width: "100%", border: '1px solid gray', m: 2, p: 1 }}>
                    <img src={pageDetails.pageData[0].chart_image} alt='chart' style={{height:'100%',width:'100%',objectFit:'contain',}} />
                </Box>
            </Container>
        </>
