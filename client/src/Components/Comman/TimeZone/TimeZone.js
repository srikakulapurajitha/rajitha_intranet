...
// const timezones = {
//     'en, { timeZone: "America/New_York" }': { timeZone: 'America/New_York' }, // US (EST)
//     'en, { timeZone: "America/Chicago" }': { timeZone: 'America/Chicago' }, // US (CST)
//     'en, { timeZone: "America/Denver" }': { timeZone: 'America/Denver' }, // US (MST)
//     'en, { timeZone: "America/Los_Angeles" }': { timeZone: 'America/Los_Angeles' }, // US (PST)
//     'en, { timeZone: "Europe/London" }': { timeZone: 'Europe/London' }, // UK
//     'en, { timeZone: "Europe/Berlin" }': { timeZone: 'Europe/Berlin' }, // Germany
//     'fr-FR, { timeZone: "Europe/Paris" }': { timeZone: 'Europe/Paris' }, // France
//     'en, { timeZone: "Asia/Manila" }': { timeZone: 'Asia/Manila' }, // Philippines
//     'en, { timeZone: "Asia/Jerusalem" }': { timeZone: 'Asia/Jerusalem' }, // Israel
    ...
    const clock = useCallback((zone) => {
        ...
        return (
            <>
                ...
                <Typography m={1} color={'gray'} component={'p'} variant='p'>{date[zone].toLocaleString()}</Typography>
                <p></p>
            </>
        )
                        ...
                        {['India', 'Israel', 'Los Angeles', 'New York', 'Chicago', 'Denver', 'UK', 'Germany', 'France', 'Philippines'].map(item => {
                            return (
                                <Grid key={item} item xs={12} lg={3}>
                                    <Container sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', m: 1 }}>
                                        {clock(item)}
                                    </Container>
                                </Grid>
                            )
